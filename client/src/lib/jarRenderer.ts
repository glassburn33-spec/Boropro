/**
 * Helper function to render a colored spherical jar to canvas
 * Used for PDF exports to display colored jar icons at scale
 */

export function renderColoredJarToCanvas(color: string, size: number = 120): string {
