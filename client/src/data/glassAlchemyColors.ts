...
export const argentGreen: FeaturedColor = {
  ...
  atmosphereData: {
    neutral: [
      { hue: "Pale green", rgb: "rgb(180, 220, 180)" },
      { hue: "Light green", rgb: "rgb(160, 210, 160)" },
      { hue: "Medium green", rgb: "rgb(140, 200, 140)" },
      { hue: "Forest green", rgb: "rgb(120, 190, 120)" },
      { hue: "Deep green", rgb: "rgb(100, 180, 100)" },
      { hue: "Dark green", rgb: "rgb(80, 170, 80)" },
    ],
    slightlyReducing: [
      { hue: "Pale metallic green", rgb: "rgb(170, 230, 170)" },
      { hue: "Metallic green", rgb: "rgb(150, 220, 150)" },
      { hue: "Rich metallic", rgb: "rgb(130, 210, 130)" },
      { hue: "Deep metallic", rgb: "rgb(110, 200, 110)" },
      { hue: "Dark metallic", rgb: "rgb(90, 190, 90)" },
      { hue: "Black-green", rgb: "rgb(70, 180, 70)" },
    ],
    reducing: [
      { hue: "Lustrous pale green", rgb: "rgb(160, 240, 160)" },
      { hue: "Lustrous green", rgb: "rgb(140, 230, 140)" },
      { hue: "Brilliant metallic", rgb: "rgb(120, 220, 120)" },
      { hue: "Deep brilliant", rgb: "rgb(100, 210, 100)" },
      { hue: "Dark brilliant", rgb: "rgb(80, 200, 80)" },
      { hue: "Black brilliant", rgb: "rgb(60, 190, 60)" },
    ],
  },
  silverEffect: {
    neutral: "Trace",
