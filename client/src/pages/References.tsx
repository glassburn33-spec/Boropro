  ...
  return (
    <div className="min-h-screen flex flex-col bg-stone-950 text-stone-100">
      ...
      <header className="sticky top-0 z-50 border-b border-white/10 bg-stone-950/95 backdrop-blur-sm">
        <div className="container flex items-center justify-between py-1 md:py-2 px-3 md:px-0">
          <a href="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
            <img src="/manus-storage/boroprologoicon_47146e54.png" alt="BoroPrologo" className="h-24 md:h-36 w-24 md:w-36 object-contain" />
          </a>
      ...
      <main className="flex-1">
        ...
        <section className="border-b border-white/10 py-8 md:py-16 px-4 md:px-0">
          <div className="container">
            <h1 className="text-2xl md:text-5xl font-bold text-yellow-400 mb-2 break-words">References</h1>
          </div>
        </section>
