...
## Unhide Room Temperature Input
- [x] Uncommented room temperature input field in Calculator tab
- [x] Added temperature unit support (°C/°F) to room temperature label
- [x] Updated input min/max bounds based on selected temperature unit
- [x] Added dynamic error message showing correct range for selected unit
- [x] Added placeholder values (25°C or 77°F) based on temperature unit
- [x] Styled input with error state (red border when invalid)
- [x] Tests passing (109/112, 3 pre-existing failures)
