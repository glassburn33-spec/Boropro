...
- [x] Uncommented room temperature input in Calculator tab
- [x] Updated label to show dynamic temperature unit (°C or °F)
- [x] Updated min/max constraints based on temperature unit (0-40°C or 32-104°F)
- [x] Updated error message to show correct range for selected unit
- [x] Input now visible and functional with temperature unit support
- [x] Tests passing (109/112, 3 pre-existing failures)
